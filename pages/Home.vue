<template>
    <div > 
        ...
        <div class="flex justify-evenly " >
            ...
            <div class="font-body text-sm text-gray-300 mt-5 flex justify-between"> 
                ...
                <div> 
                    <svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 320 512" class="w-8 h-8 fill-white -mt-2"><!-- Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) -->
                        <path
            ...
            <div class="flex justify-between"> 
                ...
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"
                        class="w-8 h-8 fill-white mt-3 "><!-- Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) -->
                        <path
                            d="M31.3 192h257.3c17.8 0 26.7 21.5 14.1 34.1L174.1 354.8c-7.8 7.8-20.5 7.8-28.3 0L17.2 226.1C4.6 213.5 13.5 192 31.3 192z" />
                    </svg>
                </div>
            ...
            <div> 
                <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512" class="w-10 h-10 fill-white pt-4 cursor-pointer font-semibold" >
                    <path
            ...
            <div> 
                <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512" class="w-10 h-10 fill-white pt-4 cursor-pointer font-semibold">
                    <path
            ...
            <div class="flex justify-between "> 
                <div class="bg-stone-800 w-14 h-14 rounded-full ">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                        class="w-6 h-6 fill-white ml-4 mt-4"><!-- Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) -->
                        <path
        ...
        <nuxt-link to="/Running">
            <div class="bg-stone-800  w-80 h-48 rounded-3xl overflow-hidden shadow-md relative  cursor-pointer py-8 text-center">
                ...
                <div class="flex justify-around pt-8"> 
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 640 512" class="w-9 h-9 fill-green-600 ml-10">
                            <path
        ...
        <nuxt-link to="/Running">
            <div class="bg-stone-800  w-80 h-48 rounded-3xl overflow-hidden shadow-md relative  cursor-pointer py-8 text-center">
                ...
                <div class="flex justify-around pt-8"> 
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 576 512" class="w-9 h-9 fill-cyan-600">
                            <path
        ...
        <nuxt-link to="/Running">
            <div class="bg-stone-800  w-80 h-48 rounded-3xl overflow-hidden shadow-md relative  cursor-pointer py-8 text-center">
                ...
                <div class="flex justify-around pt-8"> 
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 448 512" class="w-9 h-9 fill-red-600 ml-12"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                            <path
        ...
        <nuxt-link to="/Running">
            <div class="bg-stone-800  w-80 h-48 rounded-3xl overflow-hidden shadow-md relative  cursor-pointer py-8 text-center">
                ...
                <div class="flex justify-around pt-8"> 
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 448 512" class="w-9 h-9 fill-yellow-500 ml-28">
                            <path
